...
// Grab NODE_ENV and CASPAR_* environment variables and prepare them to be
// injected into the application via DefinePlugin in Webpack configuration.
const CASPAR = /^CASPAR_/i

function getClientEnvironment(options) {
  const raw = Object.keys(process.env)
    .filter(key => CASPAR.test(key))
    .reduce(
      (env, key) => {
